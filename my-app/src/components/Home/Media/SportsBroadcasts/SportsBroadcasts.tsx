...
export const SportsBroadcasts: React.FC<SportsBroadcastsProps> = ({ className }) => {
    return (
      <div className="w-full flex flex-col">
        ...
        <div className="flex flex-col gap-[8px] lg:flex-row lg:gap-[54px] px-[18px] py-[18px] lg:pl-[38px] lg:pr-[0px] lg:py-[38px]">
          <div className="flex flex-col gap-[12px]">
            <div className="w-[322px] h-[152px] lg:w-[735px] lg:h-[348px] rounded-[8px] bg-[#202327]"></div>
            <div className="flex flex-col-reverse lg:flex-col gap-[12px]">
          ...
          <div
            className="flex lg:flex-col gap-[18px] lg:gap-[25px] overflow-x-auto flex-nowrap lg:overflow-visible "
            style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
          >
            {[1, 2, 3].map((_, index) => (
              <div
                key={index}
                className="flex flex-col lg:flex-row gap-[18px] lg:gap-[10px]"
              >
                <div className="w-[165px] h-[120px] bg-[#202327]" />
                <div className="flex flex-col gap-[10px] w-[165px] lg:w-[225px]">
                  <div className="flex flex-col-reverse lg:flex-col gap-[12px]">
                    ...
                    <p className="text-white font-proxima font-bold text-[14px] leading-[17px] text-left">
                      Рыбакина на старте «РГ»-2025: сопротивление, стиль и
                      настрой <br className="hidden lg:block" />
                      на победу
                    </p>
                  </div>
                </div>
